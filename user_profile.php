...
<body>
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <?php
                if(isset($_GET['u_id'])){
                    ...
                    if($user_id == $userown_id){
                        echo "<a href='edit_profile.php?u_id=$userown_id' class='btn btn-success'>Редактировать профиль</a><br><br><br>";
                    }
            ...
            ?>
            <div class="col-sm-8">
                <center><h1>Публикации <strong><?php echo "$f_name $l_name" ?></strong></h1></center>
                <?php 
                    global $con;
