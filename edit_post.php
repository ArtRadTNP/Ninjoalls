    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <form action="" method="post" id="f">
                <center><h2>Радактируйте ваш пост:</h2></center><br>
                <textarea class="form-control" cols="83" rows="4" name="content"><?php echo $post_con; ?>
                </textarea><br>
                <input type="submit" name="update" value="Обновить публикацию" class="btn btn-info"/>
            </form> 
            ...
            <?php
                if(isset($_POST['update'])){
                    ...
                    if($run_update){
                        echo "<script>alert('Публикация была обновлена!')</script>";
