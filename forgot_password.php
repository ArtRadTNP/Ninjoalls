    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="main_content">
                <div class="header">
                    <h3 style="text-align: center;"><strong>Восстановление аккаунта.</strong></h3><hr>
                </div>
                <div class="l_pass">
                    <form action="" method="POST">
                        ...
                        <hr>
                        <pre class="text">Введите имя вашего лучшего друга.</pre>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                            <input id="msg" type="text" class="form-control" name="recovery_account" placeholder="Имя лучшего друга" required>
                        </div><br>
                        <a style="text-decoration: none; float: right; color: #187FAB;" data-toggle="tooltip" title="Signin" href="signin.php">Вернутся к авторизации?</a><br><br>
    ...
    if (isset($_POST['submit'])) {
        ...
        $check_user = mysqli_num_rows($query);
         if($check_user == 1){
             ...
             echo "<script>alert('Ваш Email или имя лучшего друга не правильны')</script>";
         }
    }
?>